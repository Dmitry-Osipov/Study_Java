...
public class RightTriangleV2 implements ShapeV2 {
    ...
    public int getKatet1() { return katet1; }

    public int getKatet2() { return katet2; }

    public double getGipotenuza() { return gipotenuza; }

    @Override
    public double getArea() { return katet1 * katet2 / 2.0; }
}
